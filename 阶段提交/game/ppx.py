...
class PPX(cocos.sprite.Sprite):
    def __init__(self, game):
        ...
        frame_1 = image.AnimationFrame(image.load('1.png'), 0.15)
        frame_2 = image.AnimationFrame(image.load('2.png'), 0.15)
        self.frames = image.Animation([frame_1, frame_2])
        frame_rush_1 = image.AnimationFrame(image.load('rush1.png'), 0.15)
        frame_rush_2 = image.AnimationFrame(image.load('rush2.png'), 0.15)
